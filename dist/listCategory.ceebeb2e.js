...
})({"4vjlo":[function(require,module,exports) {
        ...
        categoryService.findAllCategories().then((data)=>{
            ...
            for(const key in data){
                ...
                list = `
                    ...
                    <a href="editCategory.html?id=${key}">delete</a> |
                    </td>
                    </tr>
                    `;
...
},{"regenerator-runtime/runtime":"dXNgZ","./models/category":"2L7K1","./services/CategoryService":"1bIMI","./constants/FirebaseConstants":"ar8Y5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4vjlo","eU1SP"], "eU1SP", "parcelRequire5df1")
